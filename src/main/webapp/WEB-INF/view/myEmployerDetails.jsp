        ...
        <div class="container mt-4">
            ...
            <div class="row">
                <div class="col-md-8 offset-md-2">
                    ...
                    <div class="row">
                        <div class="col-md-8 offset-md-2">
                            <c:forEach var="job" items="${userJobPosts}">
                                <!-- Job Box -->
                                <div class="job-box mb-3 p-3 border rounded">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="d-flex">
                                            <div class="me-2">
                                                <a href="updatePost.htm?jobId=${job.id}" class="btn btn-primary">Update</a>
                                            </div>
                                            <div>
                                                <a href="deletePost.htm?jobId=${job.id}" class="btn btn-primary">Delete</a>
                                            </div>
                                        </div>
                                    </div>
                                    <p class="m-0">Company: ${job.company}</p>
                                    <!-- Add more job details here -->
                                </div>
                                <!-- End Job Box -->
                            </c:forEach>
                            <!-- If no job posts found -->
                            <c:if test="${empty userJobPosts}">
                    ...
                    <a href="report.htm" class="btn btn-primary">Generate Report</a>
                </div>
            </div>
        </div>
