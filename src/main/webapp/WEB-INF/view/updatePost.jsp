                    ...
                    <body>
                        ...
                        <div class="job-container">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form:form action="updatePost.htm" method="post" modelAttribute="job">
                                        <div class="mb-3">
                                            <label>Title <span class="required-field"></span></label>
                                            <form:input type="text" path="title" class="form-control" value="${job.title}" />
                                            <form:errors path="title" cssClass="error" />
                                        </div>
                                        <div class="mb-3">
                                            <label>Company<span class="required-field"></span></label>
                                            <form:input type="text" path="company" class="form-control" value="${job.company}"/>
                                            <form:errors path="company" cssClass="error" />
                                        </div>
                                        <div class="mb-3">
                                            <label>Place<span class="required-field"></span></label>
                                            <form:input type="text" path="place" class="form-control" value="${job.place}"/>
                                            <form:errors path="place" cssClass="error" />
                                        </div>
                                        <div class="mb-3">
                                            <label>Pay</label>
                                            <form:input type="text" path="pay" class="form-control" value="${job.pay}"/>
                                        </div>
                                        <div class="mb-3">
                                            <label>Mode</label>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <form:textarea path="description" class="form-control" value="${job.description}"></form:textarea>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <form:input type="text" path="education" class="form-control" value="${job.education}"/>
                                        </div>
                                        <div class="mb-3">
                                            <label>Full Address</label>
                                            <form:input type="text" path="fullAddress" class="form-control" value="${job.fullAddress}"/>
                                        </div>
                                        <div class="mb-3">
                                            <label>Full Description<span class="required-field"></span></label>
                                            <form:textarea path="fullDesc" class="form-control" value="${job.fullDesc}"></form:textarea>
                                            <form:errors path="fullDesc" cssClass="error" />
                                        </div>
                                        <form:input type="hidden" path="posted_by" class="form-control" value="${job.posted_by}"/>
                                        <form:input type="hidden" path="id" class="form-control" value="${job.id}"/>
                                        <button class="btn btn-primary col-md-12 mb-3">Update Job</button><br />
                                    </form:form>
                                </div>
                            </div>
                        </div>
